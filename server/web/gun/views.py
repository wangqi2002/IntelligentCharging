...
# 增
@gun.route('/car/create', methods=['POST'])
...
# 删
@gun.route('/car/delete/<id>', methods=['DELETE'])
...
# 改
@gun.route('/car/changeIfon/<id>', methods=['PUT'])
def up_us_data(id):
    add_us_data = request.get_json()
...
# 查
@gun.route('/car/info', methods=['GET'])
...
# 查
@gun.route('/car/list', methods=['GET'])
def get_data_by_us_name():

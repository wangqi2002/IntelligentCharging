...
# 增
@order.route('/car/create', methods=['POST'])
...
# 删
@order.route('/car/delete/<id>', methods=['DELETE'])
...
# 改
@order.route('/car/changeIfon/<id>', methods=['PUT'])
def up_us_data(id):
    add_us_data = request.get_json()
...
# 查
@order.route('/car/info', methods=['GET'])
...
# 查
@order.route('/car/list', methods=['GET'])
def get_data_by_us_name():
